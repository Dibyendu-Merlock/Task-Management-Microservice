        ...
        <div>
          ...
          >
            {auth.user?.role === "ROLE_ADMIN" ? [
              ...
              <MenuItem key="userList" onClick={handleOpenUserList}>
              Assigned User
            </MenuItem>,
            <MenuItem key="submissionList" onClick={handleOpenSubmissionList}>
              See Submissions
            </MenuItem>,
            ...
            <MenuItem key="delete" onClick={handleDeleteTask}>
              ...
              <MenuItem key="submit" onClick={handleOpenSubmitFormModel}>Submit</MenuItem>
